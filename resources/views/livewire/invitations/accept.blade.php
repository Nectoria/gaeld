...
new class extends Component {
    ...
    public function mount(string $token): void
    {
        ...
        if (Auth::check() && Auth::user()->email !== $this->invitation->email) {
            $this->error = 'This invitation was sent to a different email address.';
            return;
        }
    }
    ...
    public function acceptInvitation(): void
    {
        ...
        if ($user->belongsToCompany($this->invitation->company_id)) {
            $this->error = 'You are already a member of this company.';
            return;
        }
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-lg p-8">
            ...
            @elseif($accepted)
                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                        You've successfully joined the company as {{ ucfirst($invitation->role) }}.
                    </p>
                    <div class="mt-6">
                        <flux:button href="{{ route('dashboard') }}" variant="primary" wire:navigate>
                            Go to Dashboard
            ...
            @else
                ...
                <div>
                    <div class="text-center mb-6">
                        ...
                        <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                            {{ $invitation->inviter->name }} has invited you to join their company
                        </p>
                    </div>
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6">
                        <h3 class="text-sm font-medium text-blue-900 dark:text-blue-300 mb-2">
                            As {{ ucfirst($invitation->role) }}, you'll be able to:
                        </h3>
                        <ul class="text-sm text-blue-800 dark:text-blue-400 space-y-1 list-disc list-inside">
                            ...
                            @elseif($invitation->role === 'accountant')
                                <li>Manage invoices and contacts</li>
                                <li>View financial reports</li>
                                <li>Export data</li>
                            @elseif($invitation->role === 'employee')
                                <li>View and create your own invoices</li>
                                <li>View contacts</li>
                                <li>Limited access to features</li>
                            @else
                                <li>View invoices and contacts</li>
