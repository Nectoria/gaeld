...
test('toggleSortDirection toggles direction for same column', function () {
    $result = $this->service->toggleSortDirection('name', 'name', 'asc');
...
test('toggleSortDirection resets to asc for different column', function () {
    $result = $this->service->toggleSortDirection('name', 'email', 'desc');
